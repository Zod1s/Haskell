...
sieve n = filter isPrime [2 .. n]
  where
    isPrime a = null [x | x <- [2 .. isqrt a], rem a x == 0]
...
biggest :: Integer
biggest = maximum $ filter isPalindrome $ zipWith (*) [999, 998 .. 100] [999, 998 .. 100]
...
isDivisibleBy1_20 n = divisible n [1 .. 20]
  where
    divisible a (x : xs) = isFactor a x && divisible a xs
    divisible a [] = True
...
takeNthPrime n = filterPrime [2 ..] n
  where
    filterPrime :: [Integer] -> Integer -> Integer
...
firstOver500 = head (filter ((> 500) . numDivisors) triangles)
  where
    numDivisors n = length (findDivisors n)
...
problem_17 :: Int
problem_17 = sum $ [length (toLetters x) | x <- [1 .. 1000]]
...
-- | Problema 26
problem_26 :: Int
problem_26 = maximum $ [decLength x | x <- [1 .. 999], odd x, x `rem` 5 /= 0]
...
-- | Problema 40
helpList :: String
helpList = concatMap show [1 ..]

problem_40 :: Int
problem_40 = d100 * d1000 * d10000 * d100000 * d1000000
  where
    d100, d1000, d10000, d100000, d1000000 :: Int
    d100 = digitToInt (helpList !! 99)
    d1000 = digitToInt (helpList !! 999)
    d10000 = digitToInt (helpList !! 9999)
    d100000 = digitToInt (helpList !! 99999)
    d1000000 = digitToInt (helpList !! 999999)
