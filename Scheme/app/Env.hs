...
data SchemeVal where
  ...
  DottedList :: [SchemeVal] -> SchemeVal -> SchemeVal
  Vector :: (Array Int SchemeVal) -> SchemeVal
  Number :: Integer -> SchemeVal
  Float :: Double -> SchemeVal
  Ratio :: Rational -> SchemeVal
  Complex :: (Complex Double) -> SchemeVal
  String :: String -> SchemeVal
  Character :: Char -> SchemeVal
  Bool :: Bool -> SchemeVal
  PrimitiveFunc ::
    ([SchemeVal] -> ThrowsError SchemeVal) -> SchemeVal
  Func ::
    { isMacro :: Bool,
      params :: [String],
      vararg :: Maybe String,
    ...
    SchemeVal
  IOFunc :: ([SchemeVal] -> IOThrowsError SchemeVal) -> SchemeVal
  Port :: Handle -> SchemeVal
...
data SchemeError where
  NumArgs :: Integer -> [SchemeVal] -> SchemeError
  TypeMismatch :: String -> SchemeVal -> SchemeError
  Parser :: ParseError -> SchemeError
  BadSpecialForm :: String -> SchemeVal -> SchemeError
  NotFunction :: String -> String -> SchemeError
  UnboundVar :: String -> String -> SchemeError
  Default :: String -> SchemeError
  DivideByZero :: SchemeError
  ReservedKeyword :: String -> SchemeError
